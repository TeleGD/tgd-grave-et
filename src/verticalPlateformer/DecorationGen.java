...
public class DecorationGen {
	...
	static {
		try {
			decorations.add(new Image("images/verticalPlateformer/Tree.png"));
			decorations.add(new Image("images/verticalPlateformer/Skeleton.png"));
			decorations.add(new Image("images/verticalPlateformer/DeadBush.png"));
			for (int i=1; i<=24; i++) {
				decorations.add(new Image("images/verticalPlateformer/TombStone"+i+".png"));
			}
